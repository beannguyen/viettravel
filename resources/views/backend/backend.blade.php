    ...
    <div class="page-header">
        ...
        <div class="page-header-top">
            <div class="container">
                <!-- BEGIN LOGO -->
                <div class="page-logo">
                    <a href="index.html"><img src="/assets/img/logo-default.png" alt="logo"
                        ...
                        <li class="dropdown dropdown-user dropdown-dark">
                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                               data-close-others="true">
                                ...
                                <span class="username username-hide-mobile">{{ $data['c_user']->username }}</span>
                            </a>
        ...
        <div class="page-header-menu">
            <div class="container">
                ...
                <div class="hor-menu ">
                    <input type="hidden" id="current-tab" value="@if(isset($data['tab']['current'])){{$data['tab']['current']}}@endif" />
                    <input type="hidden" id="sub-tab" value="@if(isset($data['tab']['sub'])){{ $data['tab']['sub'] }}@endif" />
                    <ul class="nav navbar-nav">
                        <li class="dashboard-nav">
                            <a href="{{ url('/dashboard') }}">Dashboard</a>
                        </li>
                        <li class="menu-dropdown classic-menu-dropdown memebers-nav">
                            <a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;">
                                Users <i class="fa fa-angle-down"></i>
                            </a>
                            <ul class="dropdown-menu pull-left">
                                <li class="sub-all-users">
        ...
        <div class="page-head">
            <div class="container">
                ...
                <div class="page-title">
                    <h1>{{ $data['page_name'] }} <small>{{ $data['page_description'] }}</small></h1>
                </div>
                <!-- END PAGE TITLE -->
            </div>
        </div>
